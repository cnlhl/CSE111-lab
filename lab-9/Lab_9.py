...
def Q4(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT s_name AS supplier, count(*) AS cnt
...
def Q5(_conn):
    ...
    try:
        ...
        output.write((header.format("country", "cnt")) + '\n')
        cur = _conn.cursor()
        cur.execute('''SELECT s_nation AS country, count(*) AS cnt
                    FROM V4
...
def Q6(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT s_name AS supplier, o_orderpriority AS priority, count(distinct ps_partkey) AS parts
...
def Q7(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT c_nation AS country, o_orderstatus AS status, count(*) AS orders
                    FROM V1, V2
                    WHERE c_custkey = o_custkey
                        AND c_region = 'AFRICA'
...
def Q8(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT count(distinct o_clerk) AS clerks
                    FROM V2, V4, lineitem
                    WHERE l_orderkey = o_orderkey
...
def Q9(_conn):
    ...
    try:
        ...
        output.write((header.format("country", "cnt")) + '\n')
        cur = _conn.cursor()
        cur.execute('''SELECT s_nation AS country, count(distinct l_orderkey) AS cnt
                    FROM V2, V4, lineitem
                    WHERE l_orderkey = o_orderkey
                        AND l_suppkey = s_suppkey
                        AND s_region = 'AFRICA'
...
def Q10(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT p_type AS part_type, min_discount, max_discount
                    FROM V10
...
def Q11(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT count(distinct l_orderkey) AS order_cnt
                    FROM lineitem, V111, V112, orders
...
def Q12(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT s_region AS region, max(s_acctbal) AS max_bal
                    FROM V4
                    GROUP BY s_region
                    HAVING max_bal > 9000''')
        rows = cur.fetchall()
...
def Q13(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT s_region AS supp_region, c_region AS cust_region, min(o_totalprice) AS min_price
                    FROM lineitem, V1, V4, orders
                    WHERE l_suppkey = s_suppkey AND
                           o_custkey = c_custkey AND
                           o_orderkey = l_orderkey
...
def Q14(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT count(*) AS items
                    FROM orders, lineitem, V1, V4
...
def Q15(_conn):
    ...
    try:
        ...
        cur = _conn.cursor()
        cur.execute('''SELECT s_region AS region, s_name AS supplier, s_acctbal AS acct_bal
                    FROM V4
